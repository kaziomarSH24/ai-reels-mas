...
RUN pip3 install --break-system-packages moviepy Pillow pysrt requests scikit-learn pandas transformers sentencepiece protobuf fastapi uvicorn pydantic yt-dlp google-generativeai openai-whisper youtube-transcript-api numpy
