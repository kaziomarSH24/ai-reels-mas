...
<body class="bg-gray-900 text-white min-h-screen flex items-center justify-center font-sans">
    ...
    <div class="bg-gray-800 p-8 rounded-xl shadow-2xl w-full max-w-lg border border-gray-700">
        ...
        <form action="<?php echo e(route('detect.emotion')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <textarea 
                    ...
                    required
                ><?php echo e(session('sentence')); ?></textarea>
            </div>
        ...
        <?php if(session('result')): ?>
            <div class="mt-8 p-5 bg-gray-900 rounded-lg border border-gray-700">
                ...
                <?php if(isset(session('result')['error'])): ?>
                    <div class="text-red-400 flex items-center">
                        <span class="text-xl mr-2">❌</span>
                        <?php echo e(session('result')['error']); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <span class="text-2xl font-bold <?php echo e($color); ?>"><?php echo e($emotion); ?> <?php echo e($emoji); ?></span>
                    </div>
                    
                    <div class="mb-4">
                        <div class="flex justify-between text-sm mb-1">
                            <span class="text-gray-400">Confidence</span>
                            <span class="text-blue-400 font-mono"><?php echo e($confidence); ?>%</span>
                        </div>
                        <div class="w-full bg-gray-700 rounded-full h-2">
                            <div class="bg-blue-500 h-2 rounded-full" style="width: <?php echo e($confidence); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center mb-4 p-3 bg-gray-800 rounded border border-gray-700">
                        ...
                        <span class="text-xl font-bold text-yellow-400"><?php echo e(session('result')['cefr_level'] ?? 'N/A'); ?></span>
                    </div>

                    <div class="bg-gray-800 p-4 rounded-lg border border-gray-600">
                        <div class="text-xs text-blue-400 uppercase tracking-wider mb-1">Bangla Translation (Teacher Agent)</div>
                        <p class="text-lg text-white font-medium"><?php echo e(session('result')['translation'] ?? 'Translation failed'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
...
<?php /**PATH /var/www/resources/views/emotion_test.blade.php ENDPATH**/ ?>